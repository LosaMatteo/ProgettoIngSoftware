...
# Form implementation generated from reading ui file 'dieta_chetogenica.ui'
#
...
class dieta_chetogenica(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">Consigliati:</span></p><p>-Carne, prodotti della pesca e uova – I gruppo fondamentale degli alimenti.</p><p>-Formaggi - II gruppo fondamentale degli alimenti.</p><p>-Grassi e oli da condimento – V gruppo fondamentale degli alimenti.</p><p>-Ortaggi – VI e VII gruppo fondamentale degli alimenti.</p><p><span style=\" font-weight:600;\">Sconsigliati:</span></p><p>-Cereali, patate e derivati – III gruppo fondamentale degli alimenti.</p><p>-Legumi – IV gruppo fondamentale degli alimenti.</p><p>-Frutti - VI e VII gruppo fondamentale degli alimenti.</p><p>-Bibite dolci, dolciumi vari, birra ecc.</p></body></html>"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("Form", "Alimenti "))
        self.label_6.setText(_translate("Form", "<html><head/><body><p>Il meccanismo di funzionamento della dieta chetogenica si basa </p><p>sulla riduzione delle calorie e dei carboidrati alimentari che, </p><p>in associazione ad un giusto livello di proteine e un elevato</p><p> contenuto percentuale di grassi, dovrebbe migliorare la </p><p>lipolisi e l\'ossidazione lipidica cellulare, quindi il consumo totale</p><p> di grassi ottimizzando il dimagrimento. La produzione di corpi</p><p> chetonici, che dev\'essere assolutamente controllata, ha la </p><p>funzione di moderare lo stimolo </p><p>dell\'appetito – per il loro effetto anoressizzante.</p></body></html>"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_5), _translate("Form", "Come funziona?"))
        self.label_7.setText(_translate("Form", "<html><head/><body><p>La produzione energetica cellulare avviene grazie alla </p><p>metabolizzazione di alcuni substrati, soprattutto glucosio</p><p> ed acidi grassi. Per lo più, questo processo inizia nel citoplasma </p><p>(glicolisi anaerobica – senza ossigeno) e termina nei </p><p>mitocondri (ciclo di Krebs – con ossigeno - e ricarica dell\'ATP).</p></body></html>"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("Form", "Metabolismo chetogenico"))
        self.label_8.setText(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">Questa strategia alimentare viene utilizzata soprattutto in tre contesti:</span></p><p>-Dimagrimento (meglio se sotto controllo medico).</p><p>-Terapia alimentare di certe patologie metaboliche come l\'iperglicemia cronica, </p><p>l\'ipertrigliceridemia (solo sotto controllo medico), l\'ipertensione arteriosa e la </p><p>sindrome metabolica (mai in presenza di patologie o sofferenza di fegato e/o reni)</p><p>-Riduzione dei sintomi associati all\'epilessia infantile (esclusivamente quando il</p><p>soggetto non risponde alla terapia farmacologica e solo sotto controllo medico).</p></body></html>"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_6), _translate("Form", "Utilizzi"))
        self.label_9.setText(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">Facilita il dimagrimento grazie a:</span></p><p>-Riduzione delle calorie totali.</p><p>-Mantenimento di glicemia e insulinemia costanti.</p><p>-Aumento del consumo di grassi a scopo energetico.</p><p>-Incremento del dispendio calorico globale per aumento .</p><p>dell\'azione dinamico specifica e del &quot;lavoro metabolico&quot;.</p><p>-Ha un effetto anoressizzante.</p></body></html>"))
