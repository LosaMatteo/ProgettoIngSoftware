...
class agg_attrezzo(object):
    ...
    def salva(self):
        ...
        obj.addToList(obj)
        obj.scriviLista("./Admin/gestione_attrezzi/listaAttrezzi.txt")
        self.Window.close()
    ...
    def setupUi(self, MainWindow):
        ...
        self.dtAcquisto = QtWidgets.QDateTimeEdit(self.centralwidget)
        ...
        self.dtMan = QtWidgets.QDateTimeEdit(self.centralwidget)
